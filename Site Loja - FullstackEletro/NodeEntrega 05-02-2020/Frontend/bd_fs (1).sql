...
--
-- Host: localhost
-- Tempo de geração: 06/12/2020 às 01:22
...
(4, 'Maria', 'maria@maria.com', 'Quero comprar televisão de tubo velha!', '2020-12-05 20:19:48'),
(5, 'Julimar', 'josejose@ponto.com', 'Quero geladeira verde. tem?', '2020-12-05 20:21:15'),
(7, 'Daniel', 'daniel@sertanejo.com', 'Quero comprar um violão!', '2020-12-05 20:31:44');
...
(1, 'Valderlei Andrade', 'Rua Juazeiro Bairro Solidade', '5594948151', '2', 2, '3500.00'),
(2, 'Juremar Santos Andrade', 'Rua Canaa Bairro Betania', '51846135168', '1', 2, '3500.00'),
(3, 'Mario Alberto Gonçaves', 'Rua Moises Bairro Solimao', '941651681', '7', 2, '3500.00'),
(4, 'Jurema Azonis', 'Rua Santo Lopes Bairro Altamira', '9484515165', '2', 2, '3500.00'),
(5, 'Sebatiana de Andrade Maroc', 'Rua Coronel Tiao do Sul Bairro Guamamirim', '559541948151', '3', 2, '3500.00'),
(6, 'Valdiney Kemilly', 'Rua Macali Calquer  Bairro Telefero', '5594948151', '3', 2, '3500.00'),
(8, 'Maria Aparecida Oculta', 'Rua Militao de Almeida do Sul Bairro Chapadao do Guarapes', '51561651516', '4', 2, '3500.00'),
(9, 'Miguelito Junior', 'Rua Sambarilove Bairro Amor', '5594948151', '2', 2, '3500.00'),
(10, 'Ana Maria Cookie', 'Rua Juazeiro do Sul Bairro Sulameiora', '77454815151', '1', 2, '3500.00'),
(11, 'Valter Disney', 'Rua Santo Expediao do Sul Bairro Macapa', '54546541651', '5', 1, '3500.00');
